...
func main() {
	...
	testData := map[string]interface{}{
		...
		"receptor": map[string]interface{}{
			...
			"razon_social": "CLIENTE GRAVADO S.A.C.",
		...
		"items": []map[string]interface{}{
			{
				...
				"numero_item": 1,
				"codigo": "P001",
				"descripcion": "Laptop HP Pavilion - Venta Gravada",
				"unidad_medida": "NIU",
				"cantidad": 2,
			...
			},
			{
				...
				"numero_item": 2,
				"codigo": "P002",
				"descripcion": "Mouse Inalámbrico - Venta Gravada",
				"unidad_medida": "NIU",
				"cantidad": 5,
				...
				"impuesto_item": []map[string]interface{}{
					{
						...
						"tasa": 18.0,
						"monto_impuesto": 45.00,
					},
				},
			},
		},
		"totales": map[string]interface{}{
			"total_valor_venta": 5250.00,
			"total_venta_gravada": 5250.00,
			"total_impuestos": 945.00,
			"total_precio_venta": 6195.00,
			"importe_total": 6195.00,
		},
	}
	
	// Enviar a SUNAT BETA
	sendToSUNAT(testData, "VENTA GRAVADA")
}
